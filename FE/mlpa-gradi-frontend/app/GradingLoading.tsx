...
const GradingLoading: React.FC<GradingLoadingProps> = ({
    examCode = "UNKNOWN",
    onComplete
}) => {
        ...
        <div className="relative w-[1152px] h-[700px] bg-white mx-auto flex flex-col justify-center items-center">
            ...
            <div className="relative mb-14">
                <svg className="animate-spin w-32 h-32" viewBox="0 0 100 100">
                    <defs>
                        <linearGradient id="spinner-gradient-g" x1="0%" y1="0%" x2="100%" y2="0%">
                            <stop offset="0%" stopColor="#AC5BF8" />
                            <stop offset="100%" stopColor="#636ACF" />
                        </linearGradient>
                    </defs>
                    <circle cx="50" cy="50" r="45" fill="none" stroke="url(#spinner-gradient-g)" strokeWidth="8" strokeLinecap="round" strokeDasharray="200" strokeDashoffset="100" />
                </svg>
            </div>
